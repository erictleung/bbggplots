...
<!-- badges: start -->
[![R build status](https://github.com/erictleung/bbggplots/workflows/R-CMD-check/badge.svg)](https://github.com/erictleung/bbggplots/actions)
...
> R data package to explore the cheery blossoms at the Brooklyn Botanic Garden
...
```
https://raw.githubusercontent.com/erictleung/bbggplots/main/data-raw/records.csv
```
